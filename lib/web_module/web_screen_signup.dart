...
class WebScreenSignUp extends StatefulWidget {
  const WebScreenSignUp({Key? key}) : super(key: key);

  @override
  _WebScreenSignUpState createState() => _WebScreenSignUpState();
}

class _WebScreenSignUpState extends State<WebScreenSignUp> {
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (builder) => WebScreenLogin()));
                  },
                  child: Container(
                    child: Text(
                      "Sign In",
  ...
  WebScreenSignUpUsers() async {
    if (userNameController.text.isEmpty ||
      ...
      if (rse != 'sucess') {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (builder) => WebScreenLogin()));
      }
    }
  }
}
